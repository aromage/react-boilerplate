...
interface SingelDropDownItem {
  id: string;
  name: string;
  icon: string;
}

interface SingleDownProps {
  className?: string;
  panelMenusClass?: string;
  iconClass?: string;
  data: SingelDropDownItem[];
  renderTrigger?: () => ReactNode;
  renderItem?: (item: SingelDropDownItem) => JSX.Element;
  title?: string;
  onClick: (item: SingelDropDownItem) => void;
}

const SingleDropDown: FC<SingleDownProps> = ({
